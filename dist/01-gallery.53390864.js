...
const markup = (0, _galleryItems.galleryItems).reduce((acc, { original, preview, description })=>acc + ` <a class="gallery__item" href="${original}">
...
},{}]},["iQmqc","6XVkV"], "6XVkV", "parcelRequired7c6")
